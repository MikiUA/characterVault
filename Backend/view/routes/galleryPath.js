...
const collectionPaths = {
    ...
    '/collections/{collectionID}': {
        get: {
            controller: (req) => get1Coll(req, { _id: req.params.charID }),
        ...
        post: {
            ...
            requestBody: {
                ...
                "properties": {
                    "charID": {
                        "type": "string",
                        "description": "_id of the character to assign"
                    },
                    "collectionID": {
                        "type": "string",
                        "description": "_id of the collection to assign to"
                    }
                }
            },
            responses: {
        ...
        "post": {
            ...
            requestBody: {
                ...
                "properties": {
                    "charID": {
                        "type": "string",
                        "description": "_id of the character to unassign"
                    },
                    "collectionID": {
                        "type": "string",
                        "description": "_id of the collection to unassign from"
                    }
                }
            },
            responses: {
                "204": { "description": "character " },
                ...ers(404, 400, 401, 403)
            }
        }
    },
...
const characterPaths = {
    '/': getItems(function getPublicChars(req) { return getChars(req, { 'view_access': 'public' }) }),
    '/characters': {
        get: { "$ref": '#/paths/~1//get' },
        post: {
            controller: newChar,
    ...
    '/characters/{charID}': {
        get: {
            controller: (req) => get1Char(req, { _id: req.params.charID }),
            middleware: authoriseViewPublic,
            "summary": "Get item",
            "responses": {
                "200": successItem,
