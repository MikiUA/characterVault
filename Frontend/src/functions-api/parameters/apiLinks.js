...
const base = 'http://192.168.137.1:8081';

const gallery = `${base}/gallery`;
export const galleryApiLinks = {
    get: {
        gallery: `${base}/gallery`,
        collection: `${base}/gallery/collections/`,//:collectionID
        character: `${base}/gallery/characters/`,//:charID

        characterListCollection: `${base}/gallery/characters/collection/`,//:collectionID

        characterListMy: `${base}/gallery/characters/my`,
        characterListUser: `${base}/gallery/characters/`,//:userID
