...
export class CHARACTER {
  _id = "";//refname=id, default is user's input+host name, only changeable on hard change for paid users
  host = "";
  is_DnD = false;
  view_access = "private";
  img_url = "";
...
export function useCharacter(newCharacter) {
  const char = useMemo(() => new CHARACTER(newCharacter), [newCharacter]);
  return char;
}
